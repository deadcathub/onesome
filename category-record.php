<?php get_header(); ?>
  ...
  <header class="page-header">
    <div class="content">
      <h1 class="page-title">Запись</h1>
      <!-- <ul class="popular">
        <li class="popular_item popular_item--title">Популярные темы</li>
        <li class="popular_item"><a href="#">Сингл</a></li>
        <li class="popular_item"><a href="#">Satisfaction</a></li>
        <li class="popular_item"><a href="#">Top Of The Pops</a></li>
        <li class="popular_item"><a href="#">Студия</a></li>
        <li class="popular_item"><a href="#">Обложка</a></li>
      </ul> -->
    </div>
  </header>
